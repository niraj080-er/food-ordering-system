...
CREATE TYPE saga_status AS ENUM ('STARTED,  FAILED, SUCED, PROCESSING, COMPENSATING,COMPENSTED');

DROP TYPE IF EXISTS outbox_status;
CREATE TYPE outbox_status AS ENUM ('  STARTED, COMPLETED, FAILED');

DROP IF EXISTS "order".payment_outbox CASCADE;
...
ON "order".payment_outbox (type,saga_status,outbox_status);
...
CREATE INDEX "restaurant_approval_outbox_status"
ON "order".restaurant_approval_outbox (type,saga_status,outbox_status);
